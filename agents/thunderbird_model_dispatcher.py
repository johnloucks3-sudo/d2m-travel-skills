...
class ModelDispatcher:
    def __init__(self):
        ...
        "big_pickle": {
            ...
            "description": "⛔ DISABLED 2026-06-20 — model unavailable/hanging. Use anthropic/claude-haiku-4-5-20251001.",
        ...
        "deepseek_v4_flash_free": {
            ...
            "description": "⛔ DISABLED 2026-06-20 — model unavailable/failing. Use anthropic/claude-haiku-4-5-20251001.",
            "cost": "$0 (OpenCode native)",
            "method": "opencode_native",
