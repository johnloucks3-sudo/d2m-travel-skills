...
- `PROPOSAL-20260710-thunderbird-generic-remediate@nexus.md` — Regent cookies expire every 365 days with zero auto-refresh (Akamai wall blocks API re-auth — requires manual browser). When nexus starts and detects expired cr
- `PROPOSAL-2026-07-12-cadence-elon.md` — QUEUE_FOR_COMMANDER
- `PROPOSAL-2026-07-12-cadence-whetstone.md` — QUEUE_FOR_COMMANDER
- `PROPOSAL-2026-07-12-cadence-sterling.md` — QUEUE_FOR_COMMANDER
- `PROPOSAL-2026-07-12-cadence-dembe.md` — QUEUE_FOR_COMMANDER
- `PROPOSAL-2026-07-12-cadence-dani.md` — QUEUE_FOR_COMMANDER
- `PROPOSAL-2026-07-12-cadence-harlan.md` — QUEUE_FOR_COMMANDER
- `PROPOSAL-2026-07-12-cadence-reyes.md` — QUEUE_FOR_COMMANDER
- `PROPOSAL-2026-07-12-cadence-luna.md` — QUEUE_FOR_COMMANDER
- `PROPOSAL-2026-07-12-cadence-naia.md` — QUEUE_FOR_COMMANDER
- `PROPOSAL-20260715-thunderbird-generic-remediate@thunderbird-fare-watch.md` — UserPromptSubmit operation blocked by hook:
- `PROPOSAL-2026-07-19-cadence-elon.md` — QUEUE_FOR_COMMANDER
- `PROPOSAL-2026-07-19-cadence-whetstone.md` — QUEUE_FOR_COMMANDER
- `PROPOSAL-2026-07-19-cadence-sterling.md` — QUEUE_FOR_COMMANDER
- `PROPOSAL-2026-07-19-cadence-dembe.md` — QUEUE_FOR_COMMANDER
- `PROPOSAL-2026-07-19-cadence-dani.md` — QUEUE_FOR_COMMANDER
- `PROPOSAL-2026-07-19-cadence-harlan.md` — QUEUE_FOR_COMMANDER
- `PROPOSAL-2026-07-19-cadence-reyes.md` — QUEUE_FOR_COMMANDER
- `PROPOSAL-2026-07-19-cadence-luna.md` — QUEUE_FOR_COMMANDER
- `PROPOSAL-2026-07-19-cadence-naia.md` — QUEUE_FOR_COMMANDER
- `PROPOSAL-20260724-d2m-icelandair-warm.md` — QUEUE_FOR_COMMANDER — technical path is clear, but this is a policy choice (manual vs automated vs API).
- `PROPOSAL-2026-07-26-cadence-elon.md` — QUEUE_FOR_COMMANDER
- `PROPOSAL-2026-07-26-cadence-whetstone.md` — QUEUE_FOR_COMMANDER
- `PROPOSAL-2026-07-26-cadence-sterling.md` — QUEUE_FOR_COMMANDER
- `PROPOSAL-2026-07-26-cadence-dembe.md` — QUEUE_FOR_COMMANDER
- `PROPOSAL-2026-07-26-cadence-dani.md` — QUEUE_FOR_COMMANDER
- `PROPOSAL-2026-07-26-cadence-harlan.md` — QUEUE_FOR_COMMANDER
- `PROPOSAL-2026-07-26-cadence-reyes.md` — QUEUE_FOR_COMMANDER
- `PROPOSAL-2026-07-26-cadence-luna.md` — QUEUE_FOR_COMMANDER
- `PROPOSAL-2026-07-26-cadence-naia.md` — QUEUE_FOR_COMMANDER
- `PROPOSAL-20260727-d2m-icelandair-warm.md` — Likely credential expiration or transient errors without graceful retry — the service crashes instead of handling predictable failure modes
...
- `P0AGE-MISSION-011` — You'll ask for status on: Close Regent cookie expiration P0 — restore session access
- `P0AGE-MISSION-033` — You'll ask for status on: Close Regent cookie P0 — restore authenticated agent-portal session
- `P0AGE-MISSION-037` — You'll ask for status on: Close Regent P0 — restore session cookie access
- `P0AGE-MISSION-045` — You'll ask for status on: Stage air options for August 29 Grandeur trio — Furlow, Nichols, Ely/Darro
- `P0AGE-MISSION-046` — You'll ask for status on: Close Regent P0 — restore cookie/session access (consolidate MISSION-001/0
