...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1781207092);
user_pref("app.update.lastUpdateTime.background-update-timer", 1781207092);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1781207092);
user_pref("app.update.lastUpdateTime.region-update-timer", 1781207092);
user_pref("app.update.lastUpdateTime.rs-experiment-loader-timer", 1781207063);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1781207092);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1781207092);
user_pref("app.update.mode", 0);
user_pref("app.update.service.enabled", false);
user_pref("apz.content_response_timeout", 60000);
user_pref("browser.bookmarks.restore_default_bookmarks", false);
user_pref("browser.contentblocking.category", "custom");
user_pref("browser.contextual-services.contextId", "113666db-abfb-43e1-95b5-afccfc3ffee0");
user_pref("browser.contextual-services.contextId.timestamp-in-seconds", 1781207062);
...
user_pref("browser.newtabpage.activity-stream.impressionId", "{ec3f3252-e9f2-4cf8-9b90-73a024d2fc71}");
...
user_pref("browser.startup.lastColdStartupCheck", 1781207063);
...
user_pref("captchadetection.lastSubmission", 1781207);
user_pref("captivedetect.canonicalURL", "");
user_pref("datareporting.dau.cachedUsageProfileGroupID", "0a19fe14-0e51-4a9e-97ed-a6cf1f5be2d0");
user_pref("datareporting.dau.cachedUsageProfileID", "aa71f2e0-4a88-4665-9a75-fef3993f7dae");
...
user_pref("extensions.webextensions.uuids", "{\"data-leak-blocker@mozilla.com\":\"d114a0ae-9348-447f-99a3-50d84aef3ca1\",\"formautofill@mozilla.org\":\"8d7e4c73-8b70-473a-b0f1-ad3a7439a6c4\",\"ipp-activator@mozilla.com\":\"726ca503-c803-4933-8baf-e6fb91dea3b5\",\"pictureinpicture@mozilla.org\":\"a369415d-cd07-496f-b8b8-744a784403dc\",\"addons-search-detection@mozilla.com\":\"0e2b00e5-858d-4e7a-8277-8e1859058033\",\"webcompat@mozilla.org\":\"9a310967-e580-48bf-b3e8-4eafebbc122d\",\"newtab@mozilla.org\":\"4d7c8e90-58c7-48f2-b1cc-85fe8127f059\",\"default-theme@mozilla.org\":\"d7939f9b-b5b6-454c-98d7-979dcc850ef7\"}");
...
user_pref("media.gmp-manager.lastCheck", 1781208113);
user_pref("media.gmp-manager.lastEmptyCheck", 1781208113);
user_pref("media.gmp-manager.updateEnabled", false);
user_pref("media.gmp.storage.version.observed", 1);
user_pref("media.videocontrols.picture-in-picture.video-toggle.first-seen-secs", 1781207082);
...
user_pref("nimbus.profileId", "c5359580-1002-46f0-91bc-3c3860628a24");
...
user_pref("toolkit.profiles.storeID", "6cc482af");
user_pref("toolkit.shutdown.fastShutdownStage", 3);
user_pref("toolkit.startup.last_success", 1781207061);
