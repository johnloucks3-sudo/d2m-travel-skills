...
Auto-invokes: Session startup inbox check
Returns: Formatted dissent summary for immediate review
...
def handle_staff_comments():
    """Execute staff comments check and return formatted summary."""
    print("\n" + "=" * 80)
