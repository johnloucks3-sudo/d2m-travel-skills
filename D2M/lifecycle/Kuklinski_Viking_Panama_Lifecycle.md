...
```mermaid
gantt
    title Kuklinski Viking Mars — Lifecycle Timeline (Apr 2026 – Jan 2027)
    ...
    TP 1.2 Airfare Search Window              :active, tp12search, 2026-04-21, 2026-06-10
    TP 1.2 Airfare SEND                       :milestone, tp12send, 2026-06-17, 0d
    TP 1.3 Hotel Search Window                :active, tp13search, 2026-04-21, 2026-06-10
    TP 1.3 Hotel Options SEND                 :milestone, tp13send, 2026-06-17, 0d

    section Phase 2 — Momentum
    TP 2.1 Excursion Search Window            :tp21search, 2026-05-05, 2026-07-25
    TP 2.1 Excursion Recs SEND                :milestone, tp21send, 2026-08-01, 0d
    Viking Excursion Window Opens             :crit, vikingexc, 2026-08-02, 1d
    TP 2.2 Monthly Validation (Apr-Nov)       :tp22, 2026-04-15, 2026-11-15
    TP 2.3 Dining Search Window               :tp23search, 2026-06-16, 2026-09-11
    TP 2.3 Dining SEND                        :milestone, tp23send, 2026-09-18, 0d
    TP 2.4 Document Audit Window              :tp24search, 2026-07-01, 2026-09-11
    TP 2.4 Document Audit SEND                :milestone, tp24send, 2026-09-18, 0d

    section Phase 3 — Pre-Departure
    TP 3.1 Pre-Voyage Brief Window            :tp31search, 2026-08-25, 2026-11-19
    TP 3.1 Pre-Voyage Brief SEND              :milestone, tp31send, 2026-11-26, 0d
    TP 3.2 Final Confirmation Compile         :tp32compile, 2026-12-01, 2026-12-08
    TP 3.2 Final Confirmation SEND            :milestone, tp32send, 2026-12-10, 0d
    TP 3.3 Send-Off SEND                      :milestone, tp33send, 2026-12-14, 0d
    EMBARKATION                               :crit, embark, 2026-12-17, 1d

    section Phase 5 — Post-Voyage
    DISEMBARKATION                            :crit, disembark, 2026-12-27, 1d
    TP 5.1 Welcome Home SEND                  :milestone, tp51send, 2026-12-28, 0d
    TP 5.2 Post-Voyage Survey SEND            :milestone, tp52send, 2027-01-03, 0d
    TP 5.3 Thank You + Referral SEND          :milestone, tp53send, 2027-01-10, 0d
    TP 5.4 Next Voyage Search                 :tp54search, 2027-01-11, 2027-01-25
    TP 5.4 Next Voyage Plant SEND             :milestone, tp54send, 2027-01-27, 0d
```
...
flowchart TD
    subgraph RESEARCH["Research & Analysis"]
        A2["A2 Dembe<br/>Research & Intel<br/>Fares, Hotels, Excursions,<br/>Dining, Destinations"]
        A9["A9 Harlan<br/>Finance<br/>Cost Analysis per Item"]
        A5["A5 Viper<br/>Strategy<br/>Fare Timing, Booking Strategy"]
    end

    subgraph CREATIVE["Creative & Voice"]
        A6["A6 Luna<br/>Creative Director<br/>Descriptions, Imagery,<br/>Ship Intel"]
        NAIA["EXEC Naia<br/>Voice & Visual<br/>High-Touch Email Review<br/>(Nov 19 - Jan 10)"]
    end

    subgraph QC["Quality Control"]
        HALE["Hale (COS)<br/>Orchestration<br/>WF-17 Gate, QC,<br/>Weekly Reports"]
    end

    subgraph CLIENT_FACE["Client Delivery"]
        DANI["Dani (A3)<br/>Concierge<br/>Final Email Formatting<br/>Guest Outreach"]
    end

    subgraph APPROVAL["Command Authority"]
        CDR["Commander<br/>Send Approval<br/>(All Client Emails)"]
    end

    subgraph SUPPORT["On-Call Support"]
        GAUGE["A7 Gauge<br/>Survey Design<br/>Post-Voyage Metrics"]
        PADRE["CH Padre<br/>Ethics (On Call)"]
        ELON["A12 ELON<br/>Automation (TBD)"]
    end

    A2 -->|"Raw research<br/>findings"| A9
    A2 -->|"Destination<br/>data"| A6
    A9 -->|"Costed<br/>options"| A5
    A5 -->|"Strategy-validated<br/>recommendations"| HALE
    A6 -->|"Polished descriptions<br/>& imagery"| HALE
    HALE -->|"QC-cleared<br/>product"| DANI
    NAIA -->|"Voice review<br/>(high-touch TPs)"| DANI
    DANI -->|"Client-ready<br/>email"| CDR
    CDR -->|"✅ APPROVED"| DANI
    GAUGE -->|"Survey design"| HALE

    style HALE fill:#1a365d,color:#fff,stroke:#2a4a7f
    style DANI fill:#2d5016,color:#fff,stroke:#3d6b1e
    style CDR fill:#7b341e,color:#fff,stroke:#9c4221
    style A2 fill:#2a4a7f,color:#fff,stroke:#1a365d
    style A9 fill:#4a5568,color:#fff,stroke:#2d3748
    style A5 fill:#4a5568,color:#fff,stroke:#2d3748
    style A6 fill:#553c9a,color:#fff,stroke:#6b46c1
    style NAIA fill:#553c9a,color:#fff,stroke:#6b46c1
    style GAUGE fill:#4a5568,color:#fff,stroke:#2d3748
    style PADRE fill:#4a5568,color:#fff,stroke:#2d3748
    style ELON fill:#4a5568,color:#fff,stroke:#2d3748
```
