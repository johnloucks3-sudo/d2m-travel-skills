...
21-night B2B2B chain on Explora II:
- **Leg 1 (M27-07):** Istanbul→Athens · May 17–24 · 7 nights
- **Leg 2 (M27-08):** Athens→Venice · May 24–31 · 7 nights
- **Leg 3 (M27-09):** Venice→Athens · May 31–Jun 7 · 7 nights

**15 ports, 6 countries, 3 sea days** — zero port overlap across legs.

---

## ITINERARY — LEG 1
**M27-07 · Explora II · Istanbul→Athens · May 17–24 · 7 nights**

| Day | Date | Port | Arrive | Depart |
|-----|------|------|--------|--------|
| 1 | Mon 5/17 | **Istanbul, Turkey** (embark) | — | Evening |
| 2 | Tue 5/18 | Marmaris, Turkey | AM | PM |
| 3 | Wed 5/19 | Bodrum, Turkey | AM | PM |
| 4 | Thu 5/20 | Patmos, Greece | AM | PM |
| 5 | Fri 5/21 | Milos, Greece | AM | PM |
| 6 | Sat 5/22 | Mykonos, Greece | AM | PM |
| 7 | Sun 5/23 | *At Sea* | | |
| 8 | Mon 5/24 | **Piraeus (Athens), Greece** (disembark/embark) | 8:00 AM | — |

## ITINERARY — LEG 2
**M27-08 · Explora II · Athens→Venice · May 24–31 · 7 nights**

| Day | Date | Port | Arrive | Depart |
|-----|------|------|--------|--------|
| 1 | Mon 5/24 | **Piraeus (Athens), Greece** (embark) | — | Evening |
| 2 | Tue 5/25 | Paros, Greece | AM | PM |
| 3 | Wed 5/26 | Rhodes, Greece | AM | PM |
| 4 | Thu 5/27 | Syros, Greece | AM | PM |
| 5 | Fri 5/28 | *At Sea* | | |
| 6 | Sat 5/29 | Hvar, Croatia | AM | PM |
| 7 | Sun 5/30 | Split, Croatia | AM | PM |
| 8 | Mon 5/31 | **Venice, Italy** (disembark/embark) | AM | — |

## ITINERARY — LEG 3
**M27-09 · Explora II · Venice→Athens · May 31–Jun 7 · 7 nights**

| Day | Date | Port | Arrive | Depart |
|-----|------|------|--------|--------|
| 1 | Mon 5/31 | **Venice, Italy** (embark) | — | Evening |
| 2 | Tue 6/1 | Rovinj, Croatia | AM | PM |
| 3 | Wed 6/2 | Dubrovnik, Croatia | AM | PM |
| 4 | Thu 6/3 | Kotor, Montenegro | AM | PM |
| 5 | Fri 6/4 | *At Sea* | | |
| 6 | Sat 6/5 | Corfu, Greece | AM | PM |
| 7 | Sun 6/6 | Milos, Greece | AM | PM |
| 8 | Mon 6/7 | **Piraeus (Athens), Greece** (disembark) | 8:00 AM | — |
...
### Ocean Terrace (OT1-OT4) — Entry Level
- **377 sqft** including private furnished terrace
- Marble bathroom with separate shower + bathtub
- Frette linens, Dyson hair dryer, Nespresso, Moët & Chandon arrival
- Complimentary stocked mini-bar (restocked daily)
- 55" TV, Starlink Wi-Fi, Bluetooth speaker
- **No butler** (butler starts at Serenity Residence)
- OT1-OT4 are identical — same cabin, different decks

### Penthouse (PH) and Above
- Separate living area + bedroom, walk-in closet
- Double vanity, soaking tub
- Guest powder room (in some categories)
- Enhanced amenities

### Residences (CO, RR, SR, CR, OR)
- Premium deck locations, expansive terraces
- SR and above: dedicated butler
- OR: three-room layout, 1,346 sqft, largest on ship

---

## SHIP SPECS — EXPLORA II
...
| GRT | 63,900 |
| Capacity | 922 guests |
| Crew | 700 (1:1.3 ratio) |
| Suites | 461 — all oceanfront, all with private terrace |
| Pools | 4 (retractable roof + adults-only aft) |
| Spa | Thermal area included (sauna, steam, vitality pool, snow room) |
| Wi-Fi | Complimentary Starlink |
| Gratuities | Included |
| Beverages | Premium spirits, wines, cocktails included |

---

## DINING — 11 VENUES

| Venue | Cuisine | Surcharge | Notes |
|-------|---------|-----------|-------|
| Marble & Co. | Steakhouse | — | Dinner. Best for splurge |
| Sakura | Pan-Asian | — | Dinner. Top-rated at sea |
| Med Yacht Club | Mediterranean | — | B/L/D. Only lunch option besides buffet |
| Filo | French/Intl | — | Lunch, dinner |
| Emporium Marketplace | Buffet | — | B/L/D. Live stations |
| Conservatory Pool Grill | Casual | — | Lunch, poolside |
| Lobby Bar & Bites | Light bites | — | Throughout day |
| **Anthology** | **Mauro Colagreco** | **EUR165 pp** | 3-Michelin-star. Only upcharge |
| Malt Whiskey Bar | Bar | — | 200+ whiskeys, cigar terrace |

---

## KEY NOTES

- **Same cabin, same ship** for all 3 legs — no repacking
- **15 unique ports** across 6 countries — Turkey, Greece, Croatia, Montenegro, Italy, Malta (Valletta on alternate routing)
- **What's included:** All meals (except Anthology), premium beverages, gratuities, Starlink Wi-Fi, thermal spa
- **Not included:** Airfare, Anthology (EUR165 pp), shore excursions, pre/post hotels, transfers, spa treatments
- **Best value:** OT1 on Deck 7 — same cabin as OT2-4 for lowest price
- **Weakness:** Only Med Yacht Club + buffet open for lunch
- **Weakness:** No shade on outdoor decks (known complaint)
- **No photographers, no art auctions, no casinos** — contemporary luxury
...
- **Explora Journeys TESS ID:** TourOperatorID 49525 (0 D2M bookings)
- **OA commission:** 18% preferred supplier, no NCFs
- **OA split:** 80/20 D2M/OA
- **BDM:** Jennifer Greenfield (contacted 4 Jun 2026 for ETAC re-activation)
- **Full research doc:** `output/Explora_Grand_Slam_Susie_2027.md`
- **Drive links:**
