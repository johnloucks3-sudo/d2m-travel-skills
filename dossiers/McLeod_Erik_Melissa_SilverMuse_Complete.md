...
*Last Updated: 2026-05-14 — T-35 validation pass complete (Hale COS). Group transfers confirmed RESOLVED; Hotel→Civitavecchia transport priced (Kiwitaxi minivan recommended, $163.50–$201.65); 8 non-transport items routed to Dani for T-21/T-30 closure. Validation report: `output/mcleod_trip_validation_20260514.md` + Drive mirror at `D2M/Clients/McLeod_Erik_McGlasson/`.*
