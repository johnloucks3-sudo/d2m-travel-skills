...
**Dreams2Memories Travel, LLC | Created: 2026-04-26 | Updated: 2026-05-13 | Owner: COS Hale**

---

## CONTACT

- **Primary:** Ann Heer — iamheer@outlook.com
- **Spouse:** Shawn Heer
- **Relationship:** Commander's neighbors — personal referral, strong trust baseline
- **Service:** *Complimentary* — confirmed by Commander ("we are not getting anything for this")
- **Tone Rule:** ⚠️ Do NOT be solicitous or sales-pushy. These are Commander's neighbors. Straight-talk only.
...
## ANN'S CONFIRMED PREFERENCES

*(Extracted from iamheer@outlook.com reply, 2026-04-28)*

### Must-Have Experiences
- Sacred temples, meditation spaces
- UNESCO historical sites
- Pre-WWII / 8th-century history
- Dawn / early morning visits (before crowds)
- Shrines with natural settings (forested, lanterns, deer)
- Cultural depth over commerce

### Explicit Rejections
- Shopping districts (Ginza, etc.) — Ann said first itinerary "leaned too heavily toward tourist attractions"
- Crowded tourist bus routes
- Commercial / retail experiences

### Pricing Requirements
- **Per-person pricing must be clearly visible** — not group totals only
- 3-tier structure (Premium A / Mid-Range B / Budget C) for every component
- Side-by-side total table (per-person AND group)
- Daughters need a budget tier that works at their level independently

### Lodging Requirements
- Kyoto: Premium ryokan (the splurge — Ann specifically requested this, 2 nights only)
- Tokyo + Osaka: Mid-range or budget acceptable
- **All properties: 1 room with 2 queen beds** (confirmed by Ann 2026-04-29 — parents + daughters sharing to manage daughters' budgets)
- Ryokan exception: Traditional tatami room, 4 futon sets — no queen beds. Must verify 4-person capacity at booking.
...
**Obon Holiday (August 13–16, 2026)** — Japan's busiest domestic travel period
- Shinkansen at capacity; advance reservations critical
- Urban accommodation scarce and premium-priced during this window
- Temples heavily crowded Aug 13–16
- **Action:** Once city structure locked, same-day Shinkansen + Osaka/Kyoto lodging booking required

**Heat:** Tokyo/Kyoto/Osaka averaging 33–36°C (91–97°F) with high humidity. Outdoor pacing essential.

**Fixed Flights:** Air booked into/out of Tokyo. Night count is fixed. Do NOT add/remove nights.
...
|------|--------|-----------------|
| 2026-04-26 | Survey sent | "A Short Japan Survey" → iamheer@outlook.com |
| 2026-04-28 | Itinerary v1 sent | "Some ideas for your Japan trip" — initial 9-day proposal |
| 2026-04-28 | Ann replied | Wanted more historical/cultural, clearer pricing per person, lodging for daughters |
| 2026-04-29 | Itinerary v2 sent | "Your Japan Itinerary — Revised with Your Preferences Built In" (Hiroshima version, tiered pricing) |
| 2026-04-29 | Ann replied | "Sounding closer... mixed budget... daughters paying their share... 1 room with 2Q beds... Kyoto ryokan 2 nights only... reviewing at FL airport" |
...
1. **Complimentary service** — no up-sell pressure, no commission orientation
2. **Tone:** Direct, informative, neighbor-to-neighbor. No concierge flair.
3. **Pricing:** Always per-person AND group total. Always three tiers. No exceptions.
4. **Daughters:** Budget tier must be viable for two young women paying independently
5. **Historical/cultural frame:** Every experience justified by history, spirituality, or cultural depth
6. **Crowds:** Early morning visits essential — Ann specifically values beating tour buses
