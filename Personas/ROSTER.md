...
Extended personas are *lenses*, not operational staff. Consultable in staff meetings and for stress-testing.

### Client Simulation (`D2M_Extended_Personas.md`)
| ID | Name | Archetype | Purpose |
|----|------|-----------|---------|
| CLT-01 | Rondo Westbrook | Tech-Phobic Elder (M, 80) | Stress-tests digital clarity, portal UX, step-by-step instructions |
| CLT-02 | Lindy Westbrook | Tech-Phobic Elder (F, 80) | Stress-tests document design, proactive communication, referral potential |
| CLT-03+ | (additional archetypes) | See file | Full spectrum of D2M client types |

See `D2M_Extended_Personas.md` for full Community Intelligence and External Advisory personas.
...
- **Dani only** speaks to clients. ZERO supplier/briefing/Commander replies.
