...
**⚠️ CLOSE-OUT RITUAL (Commander directive 2026-07-06):** Before declaring any issue/task closed, use the tools at hand and ask Silver — literally consult him, not skip the step — three questions: **"What is the Commander likely to want next? Want to do next? Want to discuss next?"** Then search real background relating to the answer (dossier, prior correspondence, TESS, whatever's relevant) before the next turn, so the response is proactive — arriving with the groundwork already done — rather than reactive. This is what "you're getting better at anticipating me" was rewarding; codify it, don't let it be a one-off.
