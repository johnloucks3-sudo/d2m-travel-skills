...
<style>
  ...
  .header-banner {
    ...
    color: #ffffff; padding: 45px 20px 35px 20px; text-align: center;
  ...
  .form-section {
    ...
    padding: 30px; margin-bottom: 30px; box-shadow: 0 8px 24px rgba(0,0,0,0.4);
    transition: transform 0.2s ease, border-color 0.2s ease;
  }
  .form-section:hover { border-color: var(--accent); }
  .section-header {
    font-size: 19px; font-weight: 700; color: var(--accent);
    border-bottom: 2px solid var(--primary-light); padding-bottom: 10px;
  ...
  input[type="text"], input[type="email"], input[type="tel"], textarea, select {
    width: 100%; padding: 13px; background-color: var(--input-bg);
    border: 1px solid var(--border); border-radius: 6px; color: var(--text);
    font-size: 14px; box-sizing: border-box; transition: all 0.2s ease;
  }
  input[type="text"]:focus, textarea:focus, select:focus {
    border-color: var(--accent); box-shadow: 0 0 0 3px rgba(200, 220, 255, 0.15); outline: none;
  }
  ...
  .checkbox-item, .radio-item {
    ...
    background: rgba(255,255,255,0.02); padding: 10px 14px; border-radius: 6px;
  ...
  .upload-box {
    ...
    border-radius: 8px; padding: 25px; text-align: center; cursor: pointer; transition: all 0.2s ease;
  }
  ...
  .auto-save-banner {
    background: rgba(35, 134, 54, 0.15); color: #4cd964;
    border: 1px solid rgba(35, 134, 54, 0.3); padding: 10px 16px;
    border-radius: 6px; font-size: 13px; margin-bottom: 20px;
    display: flex; align-items: center; gap: 8px;
  }
  .prefill-tag {
    font-size: 11px; background: rgba(212, 175, 55, 0.15); color: var(--gold);
    padding: 2px 8px; border-radius: 4px; border: 1px solid rgba(212, 175, 55, 0.3);
  ...
  .btn-submit {
    ...
    padding: 16px 45px; border: 1px solid var(--accent); border-radius: 6px;
    cursor: pointer; text-transform: uppercase; letter-spacing: 1px;
    box-shadow: 0 4px 15px rgba(7, 7, 107, 0.4); transition: all 0.2s ease;
  }
...
<div class="container">
  ...
  <div class="auto-save-banner">
    <span>💾 <strong>Pre-Filled & Auto-Save Active:</strong> Known Spencer family details have been pre-populated for your convenience. Please review and complete missing items.</span>
  </div>

  <form action="/intake/submit" method="POST" enctype="multipart/form-data" id="spencerIntakeForm">
    
    <!-- SECTION 1 (PRE-FILLED PRIMARY CONTACT) -->
    <div class="form-section">
      <div class="section-header"><span>📋</span> Section 1 — Primary Booking Contact Information</div>
      <div class="form-group">
        <label>Primary Contact Full Legal Name * <span class="prefill-tag">Pre-filled</span></label>
        <input type="text" name="primary_name" required value="Mr. James William Spencer" placeholder="e.g., James William Spencer (Bill)">
      </div>
      <div class="form-group">
        <label>Preferred Moniker / Name <span class="prefill-tag">Pre-filled</span></label>
        <input type="text" name="preferred_name" value="Bill Spencer" placeholder="e.g., Bill">
      </div>
      <div class="form-group">
    ...
    <!-- SECTION 2 (PRE-FILLED PASSPORT & ROSTER DATA) -->
    <div class="form-section">
      <div class="section-header"><span>🛂</span> Section 2 — Passenger Roster & Security Identifiers</div>
      <div class="form-group">
        <label>12-Passenger Legal Passport & Security Roster * <span class="prefill-tag">Pre-filled Manifest</span></label>
        <div class="description">Review and complete missing Passport #, Issue Date, Expiration Date, KTN, and Global Entry ID for all 12 travelers.</div>
        <textarea name="passport_roster" rows="13" required>Pax 1: Mr. James William Spencer ("Bill") | DOB: 02/28/1953 (74yo) | Passport #: XXXXXX | Issue: MM/DD/YYYY | Exp: MM/DD/YYYY | Country: USA | KTN: 
Pax 2: Mrs. Kathleen Denise Spencer ("Kathy") | DOB: 06/12/1955 (72yo) | Passport #: XXXXXX | Issue: MM/DD/YYYY | Exp: MM/DD/YYYY | Country: USA | KTN: 
Pax 3: Mr. Michael Robert Yaggi ("Mike") | DOB: 05/06/1977 (50yo) | Passport #: XXXXXX | Issue: MM/DD/YYYY | Exp: MM/DD/YYYY | Country: USA | KTN: 
Pax 4: Mr. William "Billy" Kendrick Spencer | DOB: 06/04/1979 (48yo) | Passport #: XXXXXX | Issue: MM/DD/YYYY | Exp: MM/DD/YYYY | Country: USA | KTN: 
Pax 5: Mrs. Katie Yaggi | DOB: 10/04/1980 (46yo) | Passport #: XXXXXX | Issue: MM/DD/YYYY | Exp: MM/DD/YYYY | Country: USA | KTN: 
Pax 6: Ms. Amanda Jean Spencer | DOB: 03/31/1987 (40yo) | Passport #: XXXXXX | Issue: MM/DD/YYYY | Exp: MM/DD/YYYY | Country: USA | KTN: 
Pax 7: Mr. Timothy James Spencer ("Tim") | DOB: 04/24/1990 (37yo) | Passport #: XXXXXX | Issue: MM/DD/YYYY | Exp: MM/DD/YYYY | Country: USA | KTN: 
Pax 8: Mrs. Katie Spencer (Tim's Wife) | DOB: 02/29/1992 (35yo) | Passport #: XXXXXX | Issue: MM/DD/YYYY | Exp: MM/DD/YYYY | Country: USA | KTN: 
Pax 9: Ms. Lillianna Kathleen Yaggi | DOB: 10/29/2008 (18yo) | Passport #: XXXXXX | Issue: MM/DD/YYYY | Exp: MM/DD/YYYY | Country: USA | KTN: 
Pax 10: Miss. Clara Elise Yaggi | DOB: 09/29/2011 (15yo) | Passport #: XXXXXX | Issue: MM/DD/YYYY | Exp: MM/DD/YYYY | Country: USA | KTN: 
Pax 11: Master James Robert Spencer | DOB: 09/04/2021 (5yo) | Passport #: XXXXXX | Issue: MM/DD/YYYY | Exp: MM/DD/YYYY | Country: USA | KTN: 
Pax 12: Master Judah Benjamin Spencer | DOB: 02/25/2025 (2yo) | Passport #: XXXXXX | Issue: MM/DD/YYYY | Exp: MM/DD/YYYY | Country: USA | KTN: </textarea>
      </div>
      ...
      <div class="form-group">
        <label>Stateroom & Hotel Bedding Preference * <span class="prefill-tag">Pre-filled Cabin Assignment</span></label>
        <div class="description">Review stateroom pairings and select bedding configurations (1 King / 2 Twins).</div>
        <textarea name="stateroom_pairing" rows="5" required>Cabin 6668 (Cat 5C Balcony): Bill Spencer + Billy Spencer (2 Twin Beds)
Cabin 6666 (Cat 5C Balcony): Kathleen Spencer + Amanda Spencer (2 Twin Beds)
Cabin 6672 (Cat 5C Balcony): Michael Yaggi + Lillianna Yaggi (2 Twin Beds)
Cabin 6670 (Cat 5C Balcony): Katie Yaggi + Clara Yaggi (2 Twin Beds)
Cabin 6656 (Cat 4C Deluxe Family): Tim Spencer + Katie Spencer + James (5yo) + Judah (2yo) (1 King + Pack-n-play / Strollers)</textarea>
      </div>
    </div>

    <!-- SECTION 3 (PRE-FILLED AIRFARE ROUTINGS) -->
    <div class="form-section">
      ...
      <div class="form-group" style="background: rgba(7, 7, 107, 0.3); padding: 16px; border-radius: 8px; border-left: 4px solid var(--accent); margin-bottom: 20px;">
        <label style="color: var(--accent); font-size: 15px;">1. Mike Yaggi Family (4 Pax: Mike, Katie, Lillianna, Clara) <span class="prefill-tag">Pre-filled DEN</span></label>
        <div class="description">Departure Airport: Denver (DEN) | Outbound: DEN→FCO (Jun 12) | Return: ZRH→DEN (Jul 2)</div>
      ...
      <div class="form-group" style="background: rgba(7, 7, 107, 0.3); padding: 16px; border-radius: 8px; border-left: 4px solid var(--accent); margin-bottom: 20px;">
        <label style="color: var(--accent); font-size: 15px;">2. Tim Spencer Family (4 Pax: Tim, Katie Spencer, James [5yo], Judah [2yo]) <span class="prefill-tag">Pre-filled DEN</span></label>
        <div class="description">Departure Airport: Denver (DEN) | Outbound: DEN→FCO (Jun 12) | Return: FCO→DEN (Jun 23 - Post-Cruise Home Branch)</div>
        <div class="radio-group">
      ...
      <div class="form-group" style="background: rgba(7, 7, 107, 0.3); padding: 16px; border-radius: 8px; border-left: 4px solid var(--accent); margin-bottom: 20px;">
        <label style="color: var(--accent); font-size: 15px;">3. Bill & Kathleen Core Group (4 Pax: Bill, Kathleen, Billy, Amanda) <span class="prefill-tag">Pre-filled DEN</span></label>
        <div class="description">Departure Airport: Denver (DEN) | Outbound: DEN→FCO (Jun 12) | Return: ZRH→DEN (Jul 2)</div>
        <div class="radio-group">
      ...
      <div class="form-group">
        ...
        <div class="checkbox-group">
          ...
          <label class="checkbox-item"><input type="checkbox" name="seating_pref[]" value="Seated Together" checked> Entire Family Seated in Same Row/Block</label>
    ...
    <!-- SECTION 4 (PRE-FILLED CELEBRATIONS & MOBILITY) -->
    <div class="form-section">
      ...
      <div class="form-group">
        <label>Dining Time & Table Configuration Preference * <span class="prefill-tag">Pre-filled Group 12</span></label>
        <div class="radio-group">
          <label class="radio-item"><input type="radio" name="dining_config" value="Group Table 12" checked> Single Large Table for Entire Party of 12 (Confirmed Preference)</label>
      ...
      <div class="form-group">
        <label>Dietary Restrictions & Medical Accommodations <span class="prefill-tag">Pre-filled Logistics</span></label>
        <textarea name="dietary_medical" rows="3">Medical & Mobility: 2 strollers for James (5yo) & Judah (2yo) in Rome & onboard. CPAP distilled water / refrigeration requirements TBD.</textarea>
      </div>

      <div class="form-group">
        <label>Special Occasion Celebrations During Voyage <span class="prefill-tag">Pre-filled Milestones</span></label>
        <textarea name="celebrations" rows="3">1. Kathleen Spencer 72nd Birthday (Jun 12, 2027 — Departure Day)
2. Bill & Kathleen Spencer 50th Wedding Anniversary
3. Lillianna Kathleen Yaggi High School Graduation
4. Michael Yaggi 50th Birthday (May 6 - Matterhorn celebration in Zermatt)</textarea>
      </div>
    </div>
    ...
    <div class="form-section">
      ...
      <div class="form-group">
        ...
        <div class="radio-group">
          <label class="radio-item"><input type="radio" name="insurance" value="Include D2M Quote" checked> Include D2M Comprehensive Travel Protection Quote for 12 Travelers</label>
    ...
    <div class="form-section">
      ...
      <div class="form-group">
        <label>What would make this Grand Voyage feel like a once-in-a-lifetime success for your family? * <span class="prefill-tag">Pre-filled Vision</span></label>
        <textarea name="trip_success_vision" rows="3" required>Creating unforgettable multi-generational memories for our family and grandkids, celebrating Kathleen's 72nd Birthday & our 50th Anniversary in luxury across Italy and Switzerland.</textarea>
      </div>
...
print("✅ Pre-filled Spencer family data deployed cleanly to intake.html & index.html!")
